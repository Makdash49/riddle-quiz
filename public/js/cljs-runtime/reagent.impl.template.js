...
var G__26269 = o;
(G__26269[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26272 = o;
(G__26272[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__26278 = props;
var G__26278__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26278,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26278);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26278__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26280){
...
var props = map__26281__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26281__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26287__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__26290 = jsprops;
(G__26290["defaultValue"] = value);

(G__26290["onChange"] = (function (p1__26289_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26289_SHARP_);
}));
...
var vec__26292 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26292,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26292,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26292,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___26353 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___26353 == null)){
} else {
var key_26354 = temp__5739__auto___26353;
(jsprops["key"] = key_26354);
}
...
var temp__5739__auto___26359 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___26359 == null)){
} else {
var key_26360 = temp__5739__auto___26359;
reagent.impl.template.oset(jsprops,"key",key_26360);
}
...
var G__26296 = reagent.impl.template.__GT_NativeWrapper();
(G__26296["name"] = c);
...
var G__26297 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26297) : reagent.impl.template.as_element.call(null,G__26297));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26300){
var G__26301 = cljs.core.first(seq26300);
var seq26300__$1 = cljs.core.next(seq26300);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26301,seq26300__$1);
}));
...
break;
default:
var G__26378 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26378;
continue;
...
var n__4613__auto___26380 = a.length;
var i_26381 = (0);
while(true){
if((i_26381 < n__4613__auto___26380)){
(a[i_26381] = reagent.impl.template.as_element((a[i_26381])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___26383 = a.length;
var i_26384 = (0);
while(true){
if((i_26384 < n__4613__auto___26383)){
var val_26385 = (a[i_26384]);
if(((cljs.core.vector_QMARK_(val_26385)) && ((reagent.impl.template.key_from_vec(val_26385) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26384] = reagent.impl.template.as_element(val_26385));

var G__26386 = (i_26384 + (1));
i_26384 = G__26386;
continue;
} else {
}
...
var ctx = ({});
var vec__26304 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26304,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26304,(1),null);
...
var G__26307 = (cljs.core.count(argv) - first_child);
switch (G__26307) {
case (0):
