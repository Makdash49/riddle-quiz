...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34351 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34351(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34360 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_34360(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34364 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34364(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34368 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34368(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34372 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34372(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34376 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34376(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34348,callback){
...
var input = map__34349__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34349__$1,new cljs.core.Keyword(null,"code","code",1586293142));
